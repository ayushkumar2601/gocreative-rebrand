    ...
    <div className="flex items-center gap-7 sm:gap-9 mt-6 pt-1">
      ...
      <div className="flex items-center gap-2 text-[#111827]">
        ...
        <div className="flex flex-col leading-tight">
          <span className="font-extrabold text-sm sm:text-[15px] tracking-tight text-[#111827]">
            TikTok
          </span>
          <span className="text-[10px] sm:text-[11px] font-medium text-[#4B5563] tracking-normal">
            Marketing Partners
          </span>
        </div>
      </div>
